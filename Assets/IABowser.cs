...
public class IABowser : MonoBehaviour
{
    ...
    void Start()
    {
        ponto1 = GameObject.Find("BowserPonto1");
        ponto2 = GameObject.Find("BowserPonto2");
        ponto3 = GameObject.Find("BowserPonto3");
        ponto4 = GameObject.Find("BowserPonto4");
