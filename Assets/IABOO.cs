...
public class IABOO : MonoBehaviour
{
    ...
    void Start()
    {
        ponto1 = GameObject.Find("BooPonto1");
        ponto2 = GameObject.Find("BooPonto2");
        ponto3 = GameObject.Find("BooPonto3");
        ponto4 = GameObject.Find("BooPonto4");
