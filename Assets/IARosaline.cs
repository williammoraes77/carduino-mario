...
public class IARosaline : MonoBehaviour
{
    ...
    void Start()
    {
        ponto1 = GameObject.Find("RosalinePonto1");
        ponto2 = GameObject.Find("RosalinePonto2");
        ponto3 = GameObject.Find("RosalinePonto3");
        ponto4 = GameObject.Find("RosalinePonto4");
