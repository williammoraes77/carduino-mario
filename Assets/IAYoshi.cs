...
public class IAYoshi : MonoBehaviour
{
    ...
    void Start()
    {
        ponto1 = GameObject.Find("YoshiPonto1");
        ponto2 = GameObject.Find("YoshiPonto2");
        ponto3 = GameObject.Find("YoshiPonto3");
        ponto4 = GameObject.Find("YoshiPonto4");
